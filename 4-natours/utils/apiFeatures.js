class APIFeatures {
  ...
  sort() {
    if (this.queryString.sort) {
      ...
      this.query = this.query.sort(sortBy); // uses mongoose sort method
  ...
  limitFields() {
    if (this.queryString.fields) {
      ...
      this.query = this.query.select("-__v"); // Display everything except this field
    }
  ...
  paginate() {
    const page = this.queryString.page * 1 || 1; // * 1 converts to a number
